...
public class Controller {
    ...
    public void fuelDelivery() {
        ...
        do {
            ...
            System.out.println("------Adding Fuel to inventory  -------");
...
return fuelGradeChoice.toLowerCase();
    ...
    public void approveFuel(String fuelGrade) {
        ...
        try {
            ...
            if (!fuelDispenser.get(pumpno).isPumpOccupied()) {
                ...
                double approvedFuel = fuelDispenser.get(pumpno).approveFuel(rate, paidAmount, fuelType);
                System.out.println("Enter the amount of fuel used in litres");
                double useFuel = scanner.nextDouble();
                fuelDispenser.get(pumpno).dispenseFuel(approvedFuel, useFuel);
    ...
    public ArrayList<Integer> showPumpStatus(){
        ...
        for(int i=0;i<fuelDispenser.size();i++){
            if(!fuelDispenser.get(i).isPumpOccupied())
            {
                pumpNumber.add(i) ;
            }
        }
  ...
  return pumpNumber;
    ...
    public void refundMoney() {
        ...
        try {
            ...
            double refundMoney = fuelDispenser.get(pumpno).refundAmount(fuelType);
